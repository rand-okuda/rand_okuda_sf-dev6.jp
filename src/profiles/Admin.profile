...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <applicationVisibilities>
        <application>TabSet</application>
    ...
    <classAccesses>
        <apexClass>InboundEmailToMailAcceptance</apexClass>
    ...
    <fieldPermissions>
        <editable>true</editable>
        <field>Construction__c.Member__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>false</editable>
        <field>Construction__c.OneWeekOlder__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>false</editable>
        <field>Construction__c.ProjectsNumber__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Construction__c.Status__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Construction__c.SubmitDay__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Construction__c.TargetJobStatus__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>false</editable>
        <field>Construction__c.TimeLimit__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
    ...
    <fieldPermissions>
        <editable>true</editable>
        <field>MailAcceptance__c.Construction__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>MailAcceptance__c.Member__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>MailAcceptance__c.Subject__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>MailAcceptance__c.TargetJobNumber__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>MailAcceptance__c.TargetJobStatus__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
    ...
    <layoutAssignments>
        <layout>Construction__c-工事案件レイアウト</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>MailAcceptance__c-受付メールレイアウト</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Member__c-現場メンバーレイアウト</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <objectPermissions>
        ...
        <allowRead>true</allowRead>
        <modifyAllRecords>true</modifyAllRecords>
        <object>MailAcceptance__c</object>
        <viewAllRecords>true</viewAllRecords>
    </objectPermissions>
    <objectPermissions>
        <allowCreate>true</allowCreate>
